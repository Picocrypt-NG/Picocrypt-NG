...
<ul>
	...
	<li>✓ <strong>CLI input safety</strong>: literal bracketed names stay literal, quoted explicit globs are available when intended, all positional operands are processed, and collisions between selected inputs or keyfiles and real output artifacts are refused without reserving obsolete temporary filenames</li>
