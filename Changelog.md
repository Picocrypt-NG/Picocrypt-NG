...
<ul>
	...
	<li>✓ <strong>CLI input safety</strong>: literal bracketed names stay literal, quoted explicit globs are available when intended, ignored operands are rejected, and output or staging collisions are refused</li>
