...
import io.github.picocrypt_ng.picocrypt_ng.OperationProgress
...
/**
 * Android-test-local data builders.
 *
 * androidTest cannot see src/test helpers, so keep a minimal duplicate here.
 */
object TestDataBuilders {
    ...
    fun createOperationState(
        ...
        detail: OperationProgressDetail = OperationProgressDetail(OperationProgress.NONE),
        progress: Float = 0.5f,
        done: Boolean = false,
        error: AppError? = null,
