...
Android's release locale configuration is generated by AGP from the seven filtered app catalogs
(`en`, `ru`, `de`, `fr`, `es`, `zh-Hans`, and `hi`) with English declared as the unqualified default;
